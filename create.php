                    ...
                    <form method="post" action="scripts/create-post.php" id="new-post">
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Title"
                                name="postTitle" autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="forum-options" id="community-options">
                            ...
                            <button tabindex="-1" data-bs-toggle="modal" data-bs-target="#cmtyModal" type="button"
                                ...
                                style="color:#FFCB05;">group_add</button>
                        </div>
                        <div class="post-btns">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group input-field">
                                            ...
                                            <input type="text" class="form-control" name="wordsToInclude"
                                                id="inputInclude4" placeholder="">
                                        </div>
                                        <div class="form-group input-field">
                                            <label for="inputPassword4">Words to exclude in the title: </label>
                                            <input type="text" class="form-control" name="wordsToExclude"
                                                id="inputExclude4" placeholder="">
                                        </div>
                                        <div class="form-group input-field">
                                            <label for="inputPassword4">Select Posts after: </label>
                                            <input type="date" class="form-control" name="postsAfterDate"
                                                id="inputExclude4" placeholder="">
                                        </div>
                                    </div>
                                </div>
